...
fn encode_once(w: usize, h: usize, planes: &(Vec<u8>, Vec<u8>, Vec<u8>), speed: u8) -> usize {
...
fn bench_encode(c: &mut Criterion) {
    ...
    for &(label, w, h) in &[("256x256", 256usize, 256usize), ("512x512", 512, 512)] {
