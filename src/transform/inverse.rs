...
static INV_TXFM_FNS: [[InvTxfmFn; 5]; 5] = [
  ...
  [
    ...
    av1_iadst8,
    av1_iadst16,
    |_, _, _| unreachable!("ADST is only defined for sizes 4/8/16 in AV1"),
    |_, _, _| unreachable!("ADST is only defined for sizes 4/8/16 in AV1"),
  ],
  [
    av1_iflipadst4,
    av1_iflipadst8,
    av1_iflipadst16,
    |_, _, _| unreachable!("FLIPADST is only defined for sizes 4/8/16 in AV1"),
    |_, _, _| unreachable!("FLIPADST is only defined for sizes 4/8/16 in AV1"),
  ],
  [
    av1_iidentity4,
    ...
    av1_iidentity16,
    av1_iidentity32,
    |_, _, _| unreachable!("IDTX is only defined for sizes 4/8/16/32 in AV1"),
  ],
  [
    av1_iwht4,
    |_, _, _| unreachable!("WHT is only defined for size 4 in AV1"),
    |_, _, _| unreachable!("WHT is only defined for size 4 in AV1"),
    |_, _, _| unreachable!("WHT is only defined for size 4 in AV1"),
    |_, _, _| unreachable!("WHT is only defined for size 4 in AV1"),
  ],
